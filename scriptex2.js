...
function verificarFim(){
    ...
    let cor2 = quadradinhos[2].style.backgroundColor;
    
    let cor3 = quadradinhos[3].style.backgroundColor;
    
    let cor4 = quadradinhos[4].style.backgroundColor;
...
function trocarCor(){
    let cor = aleartorio(0,3);
    /*this quem executou*/ this.style.backgroundColor = cores[cor];

    verificarFim();
    
}

// quadradinhos[0].onmouseenter = trocarCor;
